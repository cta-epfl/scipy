...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    def _evaluate_linear(self, indices, norm_distances):
        t0 = time.time()
        print("\033[31mstarting to _evaluate_linear", indices.shape, norm_distances.shape, "\033[0m")
        ...
        print("\033[31m_evaluate_linear: after loop", time.time() - t0, "tzip=", tzip, "tweights=", tweights, "tasarray=", tasarray, "in hypercube", i, "\033[0m")
